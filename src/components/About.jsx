...
import { initTextScrambleEffect } from "../Hooks/TextAnimation";

function About() {
  useEffect(() => {
    initTextScrambleEffect("p", "#text-block");
  }, []);
    ...
    >
      <section className="flex flex-col h-screen justify-center items-center px-6">
        <div>
          ...
          <p
            id="text-block"
            className="max-w-xl text-md xl:text-lg text-slate-300 mt-4 xl:mt-10"
          >
            ...
            my <span className="text-[#9AEBA3]">experiences</span>, knowledge
            and <span className="text-[#9AEBA3]">projects</span>.
            <br />
            <br />
